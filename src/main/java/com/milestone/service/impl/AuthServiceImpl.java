 ...
 *
 * <p>This implementation uses {@link UserRepository} to check if a username exists
 * and whether the provided password matches the stored password.</p>
 * 
 * author Casey
 * version 1.1
 */
...
public class AuthServiceImpl implements AuthService {
     ...
     *
     * @param username the username to authenticate; cannot be null
     * @param password the password to check; cannot be null
